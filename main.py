...
def main():
    last_frida_tag = os.getenv('tag') #util.get_last_frida_tag()
    last_project_tag = os.getenv('tag') #util.get_last_project_tag()
    last_commit_tag = os.getenv('tag') #util.get_last_commit_tag()
    new_project_tag = "0"
